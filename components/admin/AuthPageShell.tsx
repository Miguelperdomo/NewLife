...
/**
 * Fondo/tarjeta compartidos por las pantallas públicas de autenticación
 * (login, olvidé mi contraseña -> actualizar contraseña) — mismo diseño,
 * distinto contenido adentro.
 */
        ...
        <div className="w-full rounded-3xl bg-white p-8 shadow-2xl shadow-black/40 sm:p-10">
          <div className="flex flex-col items-center text-center">
            <span className="relative flex h-14 w-14 items-center justify-center">
              <span className="absolute h-14 w-14 rounded-2xl bg-accent-400/20 blur-md" aria-hidden="true" />
